...
{{< example >}}
      ...
      <div class="border rounded shadow-sm">
        <div class="card border border-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="position-absolute top-0 end-0 btn-group" role="group" aria-label="Horizontal radio toggle button group">
  ...
  <label class="btn bg-success rounded-pill border-0" for="vbtn-radio2"><i class="fa fa-circle-check me-2"></i>Complete</label>
</div>
