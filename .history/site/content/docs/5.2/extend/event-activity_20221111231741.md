...
{{< example >}}
  <div class="d-flex flex-wrap align-items-top gap-4 p-3">
    <div class="col-12 col-sm-8  d-flex flex-fill position-relative">
      ...
      <div class="border rounded shadow-sm overflow-hidden"data-observe-resizes>
        <div class="card border border-0" >
          <div class="row g-0">
            <div class="tov-lessonActivity-event col-0 col-xl-3 border border-0 position-relative">
