...
<div class="container text-center p-0">
  <div class="row g-4">
    <div class="col-12">
      <div class="p-0 bg-light border border-0 overflow-hidden rounded-2 shadow-sm"><img src="/docs/5.2/assets/img/tovuti/space2.jpg" class="object-fit-cover shadow-none img-fluid "></div>
    </div>
    <div class="col-8">
