...
<div class="code-block code-block--expanded">
              <div class="code-block__preview" style="width: 1177px;">
              ...
              <div class="code-block__buttons">
                ...
                <button type="button" class="code-block__button code-block__toggle" aria-expanded="true" aria-controls="code-block-source-group-1">
                  Source
