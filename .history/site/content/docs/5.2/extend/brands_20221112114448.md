...
<!-- Columns start at 50% wide on mobile and bump up to 33.3% wide on desktop -->
        ...
        <div class="col-12 col-md-4 XS SM MD LG XL d-flex flex-column gap-3">
            ...
            <div class="card border shadow-sm">
              ...
              <div class="card border shadow-sm">
                ...
                <div class="card-body">
    <select class="form-control" name="choices-multiple-remove-button" id="choices-multiple-remote-fetch" placeholder="This is a placeholder" multiple>
  ...
  <script>
      document.addEventListener('DOMContentLoaded', function() {
        var genericExamples = document.querySelectorAll('#choices-multiple-remote-fetch');
