              ...
              <div class="card-body">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      <div class="text-start">
                        <label for="brandDescription" class="form-label">Brand name</label>
                        <input type="description" class="form-control" id="brandDescription" aria-describedby="brandDescription" placeholder="Infor">
