            ...
            <div class="col-md-8 p-0">
              ...
              <div class="card-body p-0 position-relative">
                ...
                <div
                  ...
                  <script>// es modules are recommended, if available, especially for typescript
import flatpickr from "flatpickr"; // creates multiple instances
flatpickr(".tov-datePicker");</script><p class="px-3 py-2 my-0"><i class="fa fa-calendar me-2"></i><em
