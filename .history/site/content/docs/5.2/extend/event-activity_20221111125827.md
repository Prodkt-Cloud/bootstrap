      ...
      <div class="border rounded shadow-sm">
        <div class="card border border-0">
          <div class="row g-0">
            ...
            <div class="position-absolute top-0 translate-middle btn-group gap-2" role="group" aria-label="Horizontal radio toggle button group justify-content-end" style="z-index:10; left: 85% !important;">
