          ...
          <div class="row g-0">
            ...
            <div class="col-md-8 p-0">
              ...
              <div class="card-body p-0">
                ...
                <div class="hstack flex-wrap gap-1 p-3 w-100 border-top justify-content-between"><span class="w-100 mb-2">Add to your calendar</span><a><img src="/docs/5.2/assets/img/tovuti/calendar/calendar_google.svg" class="w-auto" style="height:40px;"></a><div class="vr"></div><a><img src="/docs/5.2/assets/img/tovuti/calendar/calendar_iCloud.svg" class="w-auto" style="height:40px;"></a><div class="vr"></div><a><img src="/docs/5.2/assets/img/tovuti/calendar/calendar_yahoo.svg" class="w-auto" style="height:40px;"></a></div>
                <div
