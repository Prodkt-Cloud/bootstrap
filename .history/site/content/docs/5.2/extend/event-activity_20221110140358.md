...
<div class="container text-center">
      ...
      <div class="border rounded shadow-sm">
        <div class="card border border-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="btn-group w-100 rounded-0" disabled role="group" aria-label="Horizontal radio toggle button group">
  ...
  <label class="btn btn-outline-danger rounded-0" for="vbtn-radio2">Complete</label>
</div>
