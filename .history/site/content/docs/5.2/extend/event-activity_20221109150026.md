...
*[contenteditable="true"]:hover + .isEditable { display: block; position: relative; width: 100%; height: 100%; left:0; top:0; box-shadow: 0px 4px 4px rgba(255, 0, 0, 0.25); border-radius:16px !important;
}
</style>
