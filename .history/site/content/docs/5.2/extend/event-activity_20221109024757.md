                ...
                <div class="card border border-0 rounded overflow-hidden">
                      <div class="row g-0">
                              <div class="col-md-4 border border-0 position-relative">
                                ...
                                <div class="position-absolute bottom-0 start-0 bg-light rounded p-2">June 8th, 2022</div>
                              </div>
                              <div class="col-md-8 p-0">
                                <div class="card-body p-0 position-relative">
                                        ...
                                        <div class="hstack flex-wrap gap-3 p-3 w-100 border-top justify-content-start h-100 mb-0">
