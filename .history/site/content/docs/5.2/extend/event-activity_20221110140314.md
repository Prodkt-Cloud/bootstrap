...
<div class="container text-center">
  ...
  <input type="radio" class="btn-check rounded-0" name="vbtn-radio" id="vbtn-radio2" autocomplete="off">
  <label class="btn btn-outline-danger" for="vbtn-radio2">Complete</label>
</div>
