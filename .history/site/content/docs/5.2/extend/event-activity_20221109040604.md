...
<div class="container text-center p-0">
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                ...
                                <div class="card-body p-0 position-relative">
                                        ...
                                        <p class="px-3 py-2 my-0"><i class="fa fa-calendar me-2"></i><em class="fw-bold fst-normal me-1">Where:</em>Get Directions to this Event</p>
                                        ...
                                        <div class="hstack bg-light flex-wrap gap-3 p-3 w-100 border-top align-items-bottom justify-content-between h-100">
                                          <span class="text-decoration-none d-flex gap-2 justify-content-center align-items-center px-3"><i class="fa-solid fa-check-to-slot"></i>Check-in to this Event</span>
                                        <button type="button" class="btn btn-light text-black text-decoration-none d-flex gap-2 justify-content-center align-items-center"><i class="fa fa-arrow-right"></i>More Details</button>
                                        </div>
                                </div>
                              </div>
