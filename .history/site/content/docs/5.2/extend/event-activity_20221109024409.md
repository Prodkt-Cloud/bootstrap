                ...
                <div class="card border border-0 rounded overflow-hidden">
                      <div class="row g-0">
                              <div class="col-md-4 border border-0 position-relative">
                                <img src="/docs/5.2/assets/img/tovuti/pricing-modifiers/img/illustration.jpg" class="border border-0 object-fit-cover img-fluid rounded-start border-end h-100 w-md-100">
                              ...
                              <div class="col-md-8 p-0">
                                <div class="card-body p-0 position-relative">
                                        ...
                                        <div class="hstack flex-wrap gap-3 p-3 w-100 border-top justify-content-center h-100 mb-0">
                                          <button type="button" class="btn btn-outline-dark d-flex gap-2 justify-content-center align-items-center w-100"><i class="fa fa-arrow-right"></i>Read Article</button>
                                        <button type="button" class="btn btn-outline-dark d-flex gap-2 justify-content-center align-items-center w-100"><i class="fa fa-arrow-right"></i>Read Article</button>
                                        </div>
                                </div>
                              </div>
