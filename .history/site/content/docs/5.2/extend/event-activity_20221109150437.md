...
.isEditable { display: none; width:10px; height: 10px; background-color: red; position: absolute: top: auto; left: auto; right: auto; bottom: auto; }
*[contenteditable="true"]:hover + .isEditable { display: inline-block !important; }
</style>
                  <h5 class="card-title text-start" contenteditable="true"><div class="isEditable">asdff</div>Example of a $eventTitle</h5>
                </div>
                <div
