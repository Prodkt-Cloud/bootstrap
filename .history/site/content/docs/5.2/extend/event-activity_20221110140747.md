...
<div class="container text-center">
  ...
  <label class="btn btn-outline-danger rounded-0" for="vbtn-radio1"><i class="fa fa-circle-xmark me-2"></i>Incomplete</label>
  <input type="radio" class="btn-check" disabled name="vbtn-radio" id="vbtn-radio2" autocomplete="off">
  <label class="btn bg-success bg-opacity-10 rounded-0" for="vbtn-radio2"><i class="fa fa-circle-xmark me-2"></i>Complete</label>
</div>
