          ...
          <div class="row g-0">
            ...
            <div class="col-md-8 p-0">
              ...
              <div class="card-body p-0">
                ...
                <div class="hstack flex-wrap gap-1 p-3 w-100 border-top h-100">
                      <div class="d-flex" x-data="{ value: ['11/09/2022'],
                          ...
                          <p class="ps-3 py-2 my-0"><i class="fa fa-calendar me-2"></i><em class="fw-bold fst-normal me-1">Date:</em></p>
                      ...
                      <p class="px-3 py-2 my-0"><i class="fa fa-alarm-clock me-2"></i><em
                      class="fw-bold fst-normal me-1">End time:</em>$time $anteMeridiem, $timeZone</p>
                      <p class="px-3 py-2 my-0"><i class="fa fa-map me-2"></i><em
                      class="fw-bold fst-normal me-1">Where:</em><a href="">Get Directions to this Event</a></p>
                </div>
                <div class="hstack flex-wrap gap-1 p-3 w-100 border-top justify-content-start h-100">
                      <div class="d-flex" x-data="{ value: ['11/09/2022'],
                              init() {
                                  let picker = flatpickr(this.$refs.picker, {
                                      dateFormat: 'm/d/Y',
                      ...
                      <p class="px-3 py-2 my-0"><i class="fa fa-alarm-clock me-2"></i><em
                      class="fw-bold fst-normal me-1">End time:</em>$time $anteMeridiem, $timeZone</p>
                      <button type="button" class="btn btn-link px-3 py-2 text-decoration-none d-flex gap-2 justify-content-center align-items-center"><img src="/docs/5.2/assets/img/tovuti/logos/teams.svg" class="object-fit-cover img-fluid" style="height: 16px;">Join with Microsoft Teams</button>
                </div>
                <div
