          ...
          <div class="row g-0">
            ...
            <div class="col-md-8 p-0">
              ...
              <div class="card-body p-0 position-relative">
                <div class="p-3">
                  <h5 class="card-title text-start" contenteditable="true">Example of a $eventTitle<div class="isEditable">asdf</div></h5>
                <style>
*[contenteditable="true"] { position: relative; }
.isEditable { display: none; }
*[contenteditable="true"]:hover > .isEditable { display: block; width:100px; height: 100px; background-color: red; position: absolute; top: -10px; left: -10px; right: auto; bottom: auto; }
</style>
                </div>
                <div
