            ...
            <!-- -->
              ...
              <div class="card-body">
                    ...
                    <div class="alert alert-primary d-flex align-items-center" role="alert">
                      ...
                      <div>
                        <i class="fa-light fa-globe"></i> Add the following CNAME records to the DNS configuration for your domain. The procedure for adding CNAME records depends on your DNS service Provider. <a href="Learn More"></a>
                      </div>
                    </div>
                    <!-- -->
                <div class="container">
