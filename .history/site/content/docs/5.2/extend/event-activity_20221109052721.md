    ...
    <div class="col-4 pe-0 h-100">
      <div class="d-flex bg-light flex-column p-0 border rounded shadow-sm">
        ...
        <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center p-3 gap-4">
          <button type="button" class="btn btn-success w-100"><i class="fa-solid fa-circle-check"></i></button>
          ...
          <button type="button" class="btn btn-dark w-100"><i class="fa-solid fa-unlock"></i></button>
        </div>
