        ...
        <div class="row g-0">
          ...
          <div class=" col-12 col-lg-9 flex-fill p-0">
            ...
            <div class="card-body p-0">
              ...
              <div class="hstack flex-wrap gap-1 p-2 p-sm-3 w-100 border-top justify-content-evenly text-center"><span
                  class="calContainer w-100 mb-2">Add this to your calendar</span>
                <div class="hstack flex-wrap w-100 justify-content-center text-center"><a
