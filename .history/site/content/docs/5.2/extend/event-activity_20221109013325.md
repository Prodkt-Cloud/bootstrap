  ...
  <div class="row g-2">
    ...
    <div class="col-4">
      <div class="d-flex bg-light flex-column p-0 border rounded shadow-sm">
        <div class="d-flex align-items-center justify-content-center gap-3 p-3 border-bottom text-success">
        ...
        <div class="d-flex align-items-center justify-content-right p-3 border-top gap-2">
          <i class="fa-solid fa-forward ms-auto"></i> <h6 class="my-0 text-end">Up next...</h6>
        </div>
      </div>
    </div>
  </div>
