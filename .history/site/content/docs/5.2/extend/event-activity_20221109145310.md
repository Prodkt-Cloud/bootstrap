          ...
          <div class="row g-0">
            ...
            <div class="col-md-8 p-0">
              ...
              <div class="card-body p-0 position-relative">
                <div class="p-3">
                <style>*[contenteditable="true"]::before { position: relative; width: 100%; height: 100%; left:0; top:0; box-shadow: 0px 4px 4px rgba(255, 0, 0, 0.25); border: 1px solid red !important;
}</style>
