...
.isEditable:default { display: none; },
h5:hover.isEditable { display: block !important; width:10px; height: 10px; background-color: red; position: absolute; top: -10px; left: -10px; right: auto; bottom: auto; }
</style>
                </div>
                <div
