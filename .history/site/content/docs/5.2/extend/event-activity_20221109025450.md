                              ...
                              <div class="col-md-8 p-0">
                                <div class="card-body p-0 position-relative">
                                        ...
                                        <div class="hstack flex-wrap gap-3 p-3 w-100 border-top align-items-bottom justify-content-start h-100">
                                          <button type="button" class="btn btn-link d-flex gap-2 justify-content-center align-items-center"><i class="fa fa-arrow-right"></i>Register for this Event</button>
