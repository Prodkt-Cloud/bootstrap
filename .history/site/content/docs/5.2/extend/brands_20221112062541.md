...
<div
    ...
    class="w-100">
    <select x-ref="select" class="w-100"></select>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script><script>$(document).ready(function() {
