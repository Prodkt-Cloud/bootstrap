...
<!-- Columns start at 50% wide on mobile and bump up to 33.3% wide on desktop -->
      <div class="row p-3">
        ...
        <div class="col-12 col-md-4 XS SM MD LG XL">
            <div class="card border shadow-sm">
              <div class="card-header bg-transparent border-bottom p-3 flex-row"><h4 class="card-title w-auto m-0">Publishing options</h4><div class="form-check form-switch w-100">
