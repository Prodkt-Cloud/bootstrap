  ...
  <div class="row g-2">
    ...
    <div class="col-8">
      <div class="border rounded shadow-sm p-0">
                <div class="card border border-0 rounded overflow-hidden h-100">
                      <div class="row g-0">
                              <div class="col-md-4 border border-0 position-relative">
                                <img src="/docs/5.2/assets/img/tovuti/pricing-modifiers/img/illustration.jpg" class="border border-0 object-fit-cover img-fluid rounded-start border-end">
                              ...
                              <div class="col-md-8 p-0">
                                <div class="card-body position-relative">
                                  ...
                                  <div class="d-flex mt-auto mb-0 gap-2 border-top p-3">
