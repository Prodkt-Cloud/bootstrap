...
{{< example >}}
      ...
      <div class="border rounded shadow-sm">
        <div class="card border border-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="position-absolute top-0 end-0 btn-group" role="group" aria-label="Vertical radio toggle button group">
  <input type="radio" class="btn-check text-light" name="vbtn-radio1" id="vbtn-radio1" autocomplete="off" checked>
  ...
  <input type="radio" class="btn-check text-light" name="vbtn-radio2" id="vbtn-radio2" autocomplete="off">
