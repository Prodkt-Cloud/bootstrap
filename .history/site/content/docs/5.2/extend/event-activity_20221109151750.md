...
*[contenteditable="true"]:hover > .isEditable { display: block; width:10px; height: 10px; background-color: red; position: absolute; top: -10px; left: -10px; right: auto; bottom: auto; border-radius: 50px; }
*[contenteditable="true"]:focus > .isEditable { outline: 0;
}
</style>
                </div>
                <div
