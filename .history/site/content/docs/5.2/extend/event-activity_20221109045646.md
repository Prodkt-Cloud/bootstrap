...
<div class="container text-center p-0">
  <div class="row g-4">
    <div class="col-12">
      <div class="p-3 bg-light border rounded shadow-sm"><img src="/docs/5.2/assets/img/tovuti/space2.jpg" class="border border-0 object-fit-cover img-fluid rounded-start border-end h-100"></div>
    </div>
    <div class="col-8">
