                              ...
                              <div class="col-md-8 p-0">
                                <div class="card-body p-0 position-relative">
                                        ...
                                        <div class="hstack flex-wrap gap-3 p-3 w-100 border-top align-items-bottom justify-content-between h-100">
                                          <button type="button" class="btn btn-link  text-decoration-none d-flex gap-2 justify-content-center align-items-center"><img src="/docs/5.2/assets/img/tovuti/logos/teams.svg" class="object-fit-cover img-fluid" style="height: 24px;">Join with Microsoft Teams</button>
                                        <p class=""><i class="fa fa-calendar me-2"></i><em class="fw-bold fst-normal me-1">When:</em>December 4th, 2022</p>
                                        </div>
                                        <div class="hstack flex-wrap gap-3 p-3 w-100 border-top align-items-bottom justify-content-between h-100">
